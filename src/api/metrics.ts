  ...
  if ('cpu_percent' in value && 'wan_rx_bps' in value) {
    ...
    return {
      ...
      firewall_state_count:
        typeof snap.firewall_state_count === 'number' ? snap.firewall_state_count : 0,
      firewall_rule_hits: Array.isArray(snap.firewall_rule_hits) ? snap.firewall_rule_hits : [],
      suricata_alert_rate:
        typeof snap.suricata_alert_rate === 'number' ? snap.suricata_alert_rate : 0,
      crowdsec_decision_rate:
        typeof snap.crowdsec_decision_rate === 'number' ? snap.crowdsec_decision_rate : 0,
    };
  }
