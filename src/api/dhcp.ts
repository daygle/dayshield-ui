...
export const getDhcpConfig = (): Promise<ApiResponse<DhcpConfig>> =>
  apiClient.get<ApiResponse<DhcpConfig>>('/dhcp/config').then((r) => r.data);

export const updateDhcpConfig = (config: Partial<DhcpConfig>): Promise<ApiResponse<DhcpConfig>> =>
  apiClient.post<ApiResponse<DhcpConfig>>('/dhcp/config', config).then((r) => r.data);

// ── DHCPv6 Config ───────────────────────────────────────────────────────────

export const getDhcp6Config = (): Promise<ApiResponse<Dhcp6Config>> =>
  apiClient.get<ApiResponse<Dhcp6Config>>('/dhcp6/config').then((r) => r.data);

export const updateDhcp6Config = (
  config: Partial<Dhcp6Config>
): Promise<ApiResponse<Dhcp6Config>> =>
  apiClient.post<ApiResponse<Dhcp6Config>>('/dhcp6/config', config).then((r) => r.data);

// ── Per-interface DHCP ────────────────────────────────────────────────────────

export const getInterfaceDhcpConfig = (
  interfaceName: string
): Promise<ApiResponse<DhcpConfigPerInterface>> =>
  apiClient
    .get<
      ApiResponse<DhcpConfigPerInterface>
...
export const updateInterfaceDhcpConfig = (
  ...
  apiClient
    .post<
      ApiResponse<DhcpConfigPerInterface>
    >(`/interfaces/${encodeURIComponent(interfaceName)}/dhcp/config`, config)
    .then((r) => r.data);

export const getInterfaceDhcp6Config = (
  interfaceName: string
): Promise<ApiResponse<Dhcp6ConfigPerInterface>> =>
  apiClient
    .get<
      ApiResponse<Dhcp6ConfigPerInterface>
...
export const updateInterfaceDhcp6Config = (
  ...
  apiClient
    .post<
      ApiResponse<Dhcp6ConfigPerInterface>
    >(`/interfaces/${encodeURIComponent(interfaceName)}/dhcp6/config`, config)
    .then((r) => r.data);
// ── Per-interface static leases ───────────────────────────────────────────────

export const getInterfaceStaticLeases = (
  interfaceName: string
): Promise<ApiResponse<DhcpStaticLease[]>> =>
  apiClient
    .get<
      ApiResponse<DhcpStaticLease[]>
...
export const createInterfaceStaticLease = (
  ...
  apiClient
    .post<
      ApiResponse<DhcpStaticLease>
    >(`/interfaces/${encodeURIComponent(interfaceName)}/dhcp/static-leases`, lease)
    .then((r) => r.data);
...
export const getDhcpStaticLeases = (): Promise<ApiResponse<DhcpStaticLease[]>> =>
  apiClient.get<ApiResponse<DhcpStaticLease[]>>('/dhcp/static-leases').then((r) => r.data);

export const createDhcpStaticLease = (
  lease: Omit<DhcpStaticLease, 'id'>
): Promise<ApiResponse<DhcpStaticLease>> =>
  apiClient.post<ApiResponse<DhcpStaticLease>>('/dhcp/static-leases', lease).then((r) => r.data);
...
export const getDhcp6StaticLeases = (): Promise<ApiResponse<Dhcp6StaticLease[]>> =>
  apiClient.get<ApiResponse<Dhcp6StaticLease[]>>('/dhcp6/static-leases').then((r) => r.data);

export const createDhcp6StaticLease = (
  lease: Omit<Dhcp6StaticLease, 'id'> & { mac?: string }
): Promise<ApiResponse<Dhcp6StaticLease>> =>
  apiClient.post<ApiResponse<Dhcp6StaticLease>>('/dhcp6/static-leases', lease).then((r) => r.data);
...
export const getInterfaceDhcp6StaticLeases = (
  interfaceName: string
): Promise<ApiResponse<Dhcp6StaticLease[]>> =>
  apiClient
    .get<
      ApiResponse<Dhcp6StaticLease[]>
...
export const createInterfaceDhcp6StaticLease = (
  ...
  apiClient
    .post<
      ApiResponse<Dhcp6StaticLease>
    >(`/interfaces/${encodeURIComponent(interfaceName)}/dhcp6/static-leases`, lease)
    .then((r) => r.data);
